...
ASSIMP_FLAGS_3_0 = -fvisibility=hidden -DASSIMP_BUILD_NO_OWN_ZLIB -DASSIMP_BUILD_BOOST_WORKAROUND # $(DontBuildImporters) $(DontBuildProcess)
ASSIMP_FLAGS_3_1 = $(ASSIMP_FLAGS_3_0) -DASSIMP_BUILD_NO_EXPORT
...
include $(CLEAR_VARS)
LOCAL_MODULE:= assimp_cmd
LOCAL_MODULE_TAGS := optional
#LOCAL_ARM_MODE := arm
ASSIMP_CMD_SRC_DIR = tools/assimp_cmd
FILE_LIST := $(wildcard $(LOCAL_PATH)/$(ASSIMP_CMD_SRC_DIR)/*.cpp)
...
LOCAL_CXXFLAGS += -DASSIMP_BUILD_NO_OWN_ZLIB -DASSIMP_BUILD_BOOST_WORKAROUND -DASSIMP_BUILD_NO_EXPORT
